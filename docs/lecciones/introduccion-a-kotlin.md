...
[Ejecuta el código](https://pl.kotl.in/LZgx1FFLc)

Por ahora, no necesitas entender cómo funciona este código, ¡solo disfrútalo! 😀

## Plataformas de aplicación para Kotlin: JVM, Android, JS, Native

Kotlin se puede utilizar en una variedad de plataformas de aplicaciones, como JVM (Java Virtual Machine), Android, JavaScript y Native. Es conocido por su flexibilidad y facilidad de uso cuando se trata de desarrollar software para diferentes plataformas.
...
- JVM: Kotlin es completamente interoperable con Java, lo que significa que Kotlin funciona muy bien con todo el código fuente y las bibliotecas de Java existentes. También permite a las empresas realizar una migración gradual de Java a Kotlin porque el código Java también puede acceder al código Kotlin. Al mismo tiempo, los desarrolladores pueden usar Kotlin como el único lenguaje para sus proyectos sin Java en absoluto.
