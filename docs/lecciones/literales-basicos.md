...
Antes de comenzar a escribir nuestros primeros programas, aprendamos los literales básicos en Kotlin: números (enteros y con decimales), caracteres, cadenas de caracteres y booleanos. Puedes encontrar estos literales en todas partes en la vida cotidiana.
...
Los valores booleanos se utilizan a menudo en programación. Básicamente, representan dos estados opuestos. Por ejemplo, un valor booleano puede expresar:
